...
//            List<Map<String, Object>> addressList = sqlSession.selectList("site.zhourui.jasperreportdemo.mapper.AddressMapper.getAllAddresses");
//            Map<String, Object> parameters = new HashMap<>();
//            Address01 address01 = sqlSession.selectOne("site.zhourui.jasperreportdemo.mapper.Address01Mapper.selectById", 1);
//            parameters.put("year", address01.getStreet());
//            parameters.put("name",address01.getFirstname()+" "+address01.getLastname());
//            parameters.put("ADDRESS_DATA", new JRBeanCollectionDataSource(addressList));
